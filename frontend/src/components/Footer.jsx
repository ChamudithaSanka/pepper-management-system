        ...
        <div className="grid grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors">Shop All Products</a></li>
              <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors">Black Pepper</a></li>
              <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors">Green Pepper</a></li>
              <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors">Processed Products</a></li>
            </ul>
          </div>

          {/* Customer Service */}
          <div>
            <h3 className="text-lg font-semibold text-green-400 mb-4">Customer Service</h3>
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-green-400 transition-colors">Track Order</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">info@ceylonpepper.com</span>
              </div>
            </div>
          </div>
        </div>
