...
const Footer = () => {
  return (
    <footer className="bg-green-300 text-gray-800 border-t border-gray-200">
      {/* Main Footer Content */}
        ...
        <div className="grid grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-gray-900 hover:text-green-600 transition-colors">Home</Link></li>
              <li><Link to="/shop" className="text-gray-600 hover:text-green-600 transition-colors">Shop All Products</Link></li>
              <li><a href="#" className="text-gray-900 hover:text-green-600 transition-colors">Black Pepper</a></li>
              <li><a href="#" className="text-gray-900 hover:text-green-600 transition-colors">Green Pepper</a></li>
              <li><a href="#" className="text-gray-900 hover:text-green-600 transition-colors">Processed Products</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-900 hover:text-green-600 transition-colors">Contact Us</a></li>
              <li><a href="#" className="text-gray-900 hover:text-green-600 transition-colors">FAQ</a></li>
              <li><a href="#" className="text-gray-900 hover:text-green-600 transition-colors">Shipping Info</a></li>
              <li><a href="#" className="text-gray-900 hover:text-green-600 transition-colors">Returns</a></li>
              <li><a href="#" className="text-gray-900 hover:text-green-600 transition-colors">Track Order</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-900">Colombo, Sri Lanka</span>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-900-600">info@ceylonpepper.com</span>
              </div>
            </div>
          </div>
        </div>
