        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-green-200 to-blue-100 text-gray-900">
                ...
                <div className="flex items-center justify-center min-h-screen">
                    <div className="text-xl bg-gradient-to-r from-white to-green-50 rounded-lg shadow-lg p-8 border border-green-200">Loading payment details...</div>
                </div>
                <Footer />
            </div>
        );
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="mb-8 bg-gradient-to-r from-white to-green-50 rounded-lg shadow-md p-4 border border-green-200">
                    <nav className="text-sm">
                        ...
                        <Link to="/checkout" className="text-green-600 hover:text-green-700 font-medium">Customer Details</Link>
                        <span className="mx-2 text-gray-500">→</span>
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-gradient-to-br from-white to-green-50 rounded-lg shadow-lg border border-green-200 p-6">
                            ...
                            {success && (
                                <div className="bg-gradient-to-r from-green-50 to-green-100 border border-green-200 text-green-700 px-4 py-3 rounded-lg mb-6 shadow-sm">
                                    {success}
                                </div>
                            )}

                            {/* Payment Method Selection */}
                            <div className="mb-6 p-4 bg-gradient-to-r from-white to-blue-50 rounded-lg border border-blue-200 shadow-sm">
                                    ...
                                    {['Credit Card', 'Bank Transfer', 'Cash on Delivery'].map((method) => (
                                        <label key={method} className="cursor-pointer">
                                            <input
                                                ...
                                                className="sr-only"
                                            />
                                            <div className={`p-3 border rounded-lg text-center transition-all duration-200 shadow-sm ${
                                                paymentData.paymentMethod === method
                                                    ? 'border-green-500 bg-gradient-to-r from-green-50 to-green-100 text-green-700 shadow-md'
                                                    : 'border-gray-300 bg-white text-gray-700 hover:border-green-400 hover:shadow-md transform hover:scale-[1.02]'
                                            }`}>
                                                {method}
                                            </div>
                                        </label>
                            ...
                            {(paymentData.paymentMethod === 'Credit Card' || paymentData.paymentMethod === 'Debit Card') && (
                                <div className="mb-6 space-y-4 p-4 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg border border-blue-200 shadow-sm">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            {paymentData.cardDetails.cardType && (
                                                <div className="absolute right-3 top-2 text-sm text-green-700 font-medium">
                                                    {paymentData.cardDetails.cardType}
                                                </div>
                                            )}
                                        </div>
                            ...
                            {paymentData.paymentMethod === 'Cash on Delivery' && (
                                <div className="mb-6 p-4 bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-300 rounded-lg shadow-sm">
                            ...
                            <div className="mb-6 p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg border border-green-200 shadow-sm">
                                <h3 className="text-lg font-medium mb-4 text-gray-900">Billing Address</h3>
                                
                                <div className="mb-4">
                                    <label className="flex items-center cursor-pointer bg-white p-3 rounded-lg border border-gray-200 hover:shadow-md transition-all duration-200">
                                        <input
                                            type="checkbox"
                                        ...
                                        />
                                        <span className="text-gray-700 font-medium">Same as delivery address</span>
                                    </label>
                                </div>
                                ...
                                {paymentData.useSameAsDelivery && (
                                    <div className="p-4 bg-gradient-to-r from-white to-green-50 border border-green-200 rounded-lg shadow-sm">
                                        <div className="text-gray-700 font-medium">📍 {formatAddress(customerDetails.deliveryAddress)}</div>
                                    </div>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-gradient-to-br from-white to-green-50 rounded-lg shadow-lg border border-green-200 p-6 sticky top-4">
                            ...
                            <div className="space-y-3 mb-6">
                                {cart.items.map((item) => (
                                    <div key={item.productId._id} className="flex justify-between text-sm p-3 bg-gradient-to-r from-white to-blue-50 rounded-lg border border-blue-200 shadow-sm">
                            ...
                            <div className="space-y-2 mb-6 p-4 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg border border-blue-200 shadow-sm">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full bg-green-600 disabled:from-gray-300 disabled:to-gray-400 disabled:cursor-not-allowed text-white font-bold py-3 rounded-lg transform hover:scale-[1.02] transition-all duration-200 shadow-md hover:shadow-lg"
                            >
