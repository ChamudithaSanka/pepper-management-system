                ...
                return (
                    <div className="space-y-6">
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-12 text-center shadow-sm">
                            ...
                            <h3 className="text-xl font-semibold text-gray-600 mb-2">Raw Materials Management</h3>
                            <p className="text-gray-400">Manage green pepper, black pepper, and other raw materials</p>
                            <div className="mt-4 text-sm text-gray-500">
                                • View Stock Levels • Add New Materials • Update Quantities • Track Expiry
                            </div>
                        </div>
                    </div>
                );
                ...
                return (
                    <div className="space-y-6">
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-12 text-center shadow-sm">
                            ...
                            <h3 className="text-xl font-semibold text-gray-600 mb-2">Products Management</h3>
                            <p className="text-gray-400">Manage finished pepper products and inventory</p>
                            <div className="mt-4 text-sm text-gray-500">
                                • Create Products • Stock Management • Recipe Management • Quality Control
                            </div>
                        </div>
                    </div>
                );
