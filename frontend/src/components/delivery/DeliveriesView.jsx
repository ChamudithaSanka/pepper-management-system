                ...
                <div className="flex items-center space-x-6">
                    ...
                    <div className="flex-1">
                        ...
                        <input
                            ...
                            value={searchTerm}
                            onChange={(e) => {
                                // Allow only letters, numbers and spaces in search — strip symbols
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {filteredTasks.map((task) => (
                                    <tr key={task._id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-2 py-2 whitespace-nowrap text-sm text-gray-900"><div className="max-w-md whitespace-normal break-words">{task.deliveryLocation?.address || 'No address available'}</div></td>
