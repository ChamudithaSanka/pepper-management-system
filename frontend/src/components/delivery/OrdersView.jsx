                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-green-700">
                                    <tr>
                                        ...
                                        <th className="px-6 py-3 text-left text-xs font-medium text-white uppercase tracking-wider">Order Date</th>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                {order.status === 'Pending' ? (
                                                    <button
                                                        ...
                                                        className="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm font-medium transition-colors border border-green-700"
                                                    >
                                                        Assign Driver
                                                    </button>
                                                ) : (
